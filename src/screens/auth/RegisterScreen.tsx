...
export default function RegisterScreen() {
  ...
  const handleGoogleSignUp = async () => {
    setLoading(true);
    try {
      // Google Sign Up will be implemented with proper OAuth flow
      Alert.alert('Google Sign Up', 'Google sign up will be implemented with OAuth flow');
    } catch (error: any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>Hesap oluşturun ve başlayın</Text>
